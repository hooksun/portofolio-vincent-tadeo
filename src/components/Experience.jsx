...
export default function Experience(){
    ...
    return <div>
        ...
        <ProjectSection
            ...
            title="resQfood"
            desc="A mobile application for ordering food online filled with features such as a recommendation system, search page, map page, favorite system, and more. This app was made with Flutter and Supabase for a group assignment and I was in charge of coding the entire app based on a design by another group member"
        />
        <ProjectSection
